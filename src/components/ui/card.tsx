  ...
  "rounded-2xl border text-card-foreground transition-all duration-300",
  {
    variants: {
      variant: {
        ...
        soft: "bg-card shadow-soft hover:shadow-hover hover:-translate-y-1",
        coral: "bg-coral-light border-coral/20",
        lavender: "bg-lavender-light border-lavender/20",
        mint: "bg-mint-light border-mint/20",
        glass: "bg-card/60 backdrop-blur-lg border-border/50",
        gradient: "bg-gradient-hero border-none",
      },
    },
    defaultVariants: {
      variant: "default",
